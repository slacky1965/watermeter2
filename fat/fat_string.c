...
//-----------------------------------------------------------------------------
static ICACHE_FLASH_ATTR int FileString_StrCmpNoCase(char *s1, char *s2, int n)
{
    int diff;
    char a,b;
...
//-----------------------------------------------------------------------------
static ICACHE_FLASH_ATTR int FileString_GetExtension(char *str)
{
    int dotPos = -1;
    char *strSrc = str;
...
// Returns -1 if not found or index otherwise
//-----------------------------------------------------------------------------
static ICACHE_FLASH_ATTR int FileString_TrimLength(char *str, int strLen)
{
    int length = strLen;
